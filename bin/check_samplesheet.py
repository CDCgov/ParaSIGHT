...
class RowChecker:
        ...
        **kwargs,
        ...
        Args:
            sample_col (str): The name of the column that contains the sample name
                (default "sample").
            first_col (str): The name of the column that contains the genomic FASTA file path (default "fasta").
    ...
    def _validate_first(self, row):
        ...
        assert len(row[self._first_col]) > 0, "A genome FASTA file is required."
    ...
    def validate_unique_samples(self):
        ...
        FASTA file combination exists.

        """
        assert len(self._seen) == len(self.modified), "The pair of sample name and FASTA must be unique."
